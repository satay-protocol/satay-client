    ...
    useEffect(() => {
        const getVault = async () => {
            const vault : Vault = {
                ...
                totalAssets: 100_000,
                id: '000',
                about: 'Aptos is a proposed Layer 1 blockchain that uses the Move programming language. The cryptocurrency promises users increased scalability, reliability, security and usability.',
                strategies: [
                    {
                        title: "APTOS/USDC Liquidity Farm",
                        description: 'This vault farms APTOS tokens by swapping 50% of deposited USDC for APTOS and adding the tokens to the APTOS/USDC liquidiy pool.'
                    }
            ]
            }
            setVault(vault);
